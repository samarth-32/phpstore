			...
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="handler/customerlogin.php" method="POST">
						...
						<div>
						<input type="radio" aria-label="Radio button for following text input" value="Admin" name="type"> Admin</input>
						<input type="radio" aria-label="Radio button for following text input" value="Customer" name="type"> Customer</input>
						</div>
